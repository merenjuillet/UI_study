...
// 오라클 서버를 경유해서 가져오는 대신에 
// 해커뉴스에서 제공하는 데이터셋을 활용해서 dom(html 요소 활용 -> React수업 선수학습)을 조작해보자
...
// 어떻게 클릭했는지 알 수 있는거니? - URL에 파라미터가 조금이라도 달라지면 새로운 요청이라고 판단하니까
// 서버에 다시 재요청이 일어날 수 있다. get 방식이더라도..
...
for (let i = 0; i < 30; i++) {
    ...
    //a.innerHTML = `${newsFeed[i].title}('57')`;
